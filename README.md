...
Project done during **Full Stack Software Engineering studies** at **ALX-Holberton School**. It aims to learn about sorting algorithms (bubble sort, insertion sort, selection sort, quick sort and so on) and Big O Notation in **C language**.
